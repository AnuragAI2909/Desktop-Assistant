...
def run_anurag():
    ...
    if 'play' in command:
        ...
        print('I am computer assistant of Mr. Anurag Singh Chauhan. Developed by him in 0ctober 2022')
        talk('I am computer assistant of Mr. Anurag Singh Chauhan. Developed by him in october twenty twent two')
        ...
        talk("Sir i'm printing the calendar of 2023, because i'm  unable to recognise you, if you want to print calendar of any other year, it will be easy for me if you enter the year" )
